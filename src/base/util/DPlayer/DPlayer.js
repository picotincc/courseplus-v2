...
class DPlayer {
    ...
    constructor(option) {
        ...
        this.element.innerHTML = `
            ...
            <div class="dplayer-video-wrap">
                ...
                <div class="dplayer-bezel">
                    ...
                    ${this.option.live ? `<span class="dplayer-live-not-start">${getTran('Live not start')}</span>` : ``}
            ...
            + `         </button>
                    ...
                    <span class="dplayer-time"><span class="dplayer-ptime">0:00</span>
                    ${this.option.live ? `` : ` / <span class="dplayer-dtime">0:00</span></span>`}
                </div>
            ...
            + `     </a>
                    ` : ``}
                    <div class="dplayer-comment" ${this.option.comment ? ``:`style="display: none;"`}>
            ...
            + `     </button>
                ...
                <div class="dplayer-bar-wrap" ${this.option.live ? `style="display: none;"`: ``}>
        ...
        if (/(m3u8\?|m3u8$)/i.exec(this.option.video.url)) {
        ...
        // Support FLV
        if (/(flv\?|flv$)/i.exec(this.option.video.url)) {
            ...
            this.liveNotStartHint = this.element.getElementsByClassName('dplayer-live-not-start')[0];
            ...
            if (this.option.danmaku && showdan) {
                if(this.option.live) {
                    danmakuTime = setInterval(() => {
                        ...
                        while (item && Date.now() >= new Date(item.createdAt).getTime()) {
        ...
        const settingHTML = {
            ...
            + `     </div>
                    ...
                    <div class="dplayer-setting-item dplayer-setting-loop" style="display:none;">
